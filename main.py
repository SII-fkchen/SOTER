import argparse
from soter.runner import MIRARunner
import re
import os
...
"""
Training entry point for SOTER.

Part of the training pipeline is adapted from:
- MIRA: https://github.com/microsoft/MIRA
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', '-m', type=str, default='YOUR_HF_USERNAME/SOTER', help='Path or Hub id of a pretrained SOTER checkpoint. With --from_scratch, only its config.json is used to initialize a new model.')
    parser.add_argument('--output_path', '-o', type=str, default='logs/soter')
